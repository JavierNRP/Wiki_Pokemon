			...
			if(oldScene == null && newScene != null) {
				...
				newScene.windowProperty().addListener((observableWindow, oldWindow, newWindow) -> {
					if(oldWindow == null && newWindow != null) {
						...
						((Stage) newWindow).onCloseRequestProperty().addListener(e -> animation.cancel(false));
						((Stage) newWindow).focusedProperty().addListener(e -> System.out.println("focused"));
						((Stage) newWindow).onCloseRequestProperty().addListener(e -> System.out.println("closed"));
					}
				});
			}
		});
